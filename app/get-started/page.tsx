...
const inputs = [
  ["API docs", "OpenAPI, REST docs, cURL"],
  ["Website URL", "forms, flows, public pages"],
  ["Workflow", "approvals, ops, support"],
];

const outputs = [
  ["search_docs", "Code Mode API manual"],
  ["execute", "no-eval SDK-style calls"],
  ["tools/call", "safe execution route"],
  ["sdk export", "SDKs, docs, CLI, manifest"],
  ["logs", "latency, status, trace"],
];
      ...
      <div className="relative border border-neutral-200 bg-white p-8 shadow-sm">
        <div className="flex items-start justify-between gap-6 border-b border-neutral-200 pb-6">
          <div>
            ...
            >
              From messy inputs to one hosted MCP endpoint.
            </h2>
          </div>
          ...
          <div className="border border-neutral-200 bg-[#111111] p-5 text-white shadow-sm">
            <div className="flex items-center gap-3 border-b border-white/10 pb-4">
              ...
              <div>
                ...
                <p className="font-mono text-xs text-white/38">generating MCP server</p>
              </div>
            </div>
          ...
          <div className="mx-auto flex w-full max-w-[420px] flex-col items-center">
            <div className="mt-auto flex w-full flex-col items-center pb-12">
              ...
              <p className="mt-5 max-w-sm text-center text-base leading-6 text-neutral-500">
                Start with an API spec, website, or workflow. Get Code Mode plus one endpoint your agent can call.
              </p>
            </div>
