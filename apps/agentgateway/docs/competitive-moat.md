...
| Policy manifest for read/write/destructive tools | Built | Add runtime-enforced per-endpoint policy toggles. |
...
| Team governance | Missing | Add RBAC, allow/deny tool policies, destructive-call approval. |
