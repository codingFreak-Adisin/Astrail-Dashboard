  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "TypeScript, Python, Go, Java, Ruby, C#, PHP, and CLI targets each have their own package metadata. Install dependencies from inside the generated target directory and use the target README commands.",
      },
      {
