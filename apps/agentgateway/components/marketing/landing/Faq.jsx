...
const faqs = [
  ...
  {
    question: 'How does someone use the generated SDK?',
    answer:
      'Open SDK Factory, choose a hosted endpoint, and download the bundle. It includes typed clients, endpoint-specific methods, install notes, examples, tests, manifests, a CLI, and GitHub workflows. Verify the bundle, import the client for your language, set ASTRAIL_API_KEY for private endpoints, and call the generated methods.',
  },
]
