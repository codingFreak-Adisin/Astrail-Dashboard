...
import { endpointRequiresAuth } from "@/lib/runtime/permissions";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid min-w-0 items-start gap-6 xl:grid-cols-2">
        <Card className="min-w-0">
          <CardHeader><CardTitle>Per-tool policy</CardTitle></CardHeader>
          <CardContent><ToolMetadataEditor serverId={server.id} tools={tools} /></CardContent>
        </Card>
        <Card className="min-w-0">
          <CardHeader><CardTitle>Connection credentials</CardTitle></CardHeader>
          <CardContent>
