...
export const billingMeters: Record<BillingMeterId, BillingMeter> = {
  ...
  mcp_generation: {
    id: "mcp_generation",
    label: "OpenAPI MCP generation",
    creditCost: 250,
    unit: "generated server",
    chargedWhen: "When Astrail saves a successful OpenAPI/docs-to-MCP endpoint.",
...
export const billingPlans: Record<BillingPlanId, BillingPlan> = {
  free: {
    ...
    features: [
      ...
      "1 OpenAPI or Website to MCP generation",
  ...
  starter: {
    ...
    features: [
      ...
      "25 OpenAPI or Website to MCP generations",
  ...
  team: {
    ...
    features: [
      ...
      "150 OpenAPI or Website to MCP generations",
