...
async function checkRuntimeTables() {
  ...
  const probes = [
    ["tool_call_logs", "id"],
    ["mcp_bundles", "id"],
    ["mcp_bundle_servers", "bundle_id"],
    ["api_credentials", "id"],
    ["tool_execution_dedup", "id"],
    ["tool_schema_versions", "id"],
    ["webhook_endpoints", "id"],
    ["webhook_events", "id"],
    ["integration_schema_versions", "id"],
    ["integration_cost_events", "id"],
    ["integration_cost_totals", "user_id"],
  ] as const;
