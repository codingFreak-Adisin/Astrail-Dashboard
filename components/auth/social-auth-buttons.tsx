    ...
    <div className="grid gap-3">
      {providers.map((provider) => (
        <a
          ...
          className="flex h-12 items-center justify-center gap-3 border border-white/15 bg-transparent px-4 text-xl font-normal text-white transition hover:border-white/35 hover:bg-white/[0.03]"
        >
          {provider.mark}
          {provider.label}
        </a>
