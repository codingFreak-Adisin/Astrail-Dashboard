...
ASTRAIL_MCP_ENDPOINT=${appUrl}/api/mcp/${serverId} node ../scripts/run-astrail-evals.mjs`;
  ...
  return (
    <div className="section-card space-y-4 text-sm">
      <div className="section-card-header pb-0">
        <div>
          <h2 className="text-lg font-semibold text-neutral-950">Create SDK bundle</h2>
          <p className="mt-0.5 text-xs text-neutral-400">Download client code and docs for this server.</p>
        </div>
      ...
      <div className="grid gap-2 sm:grid-cols-4">
        {bundleItems.map((item) => (
          <div key={item} className="flex items-center gap-2 rounded-xl border border-neutral-100 bg-neutral-50/80 px-3 py-2 text-neutral-500">
      ...
      <details className="rounded-xl border border-neutral-100 bg-neutral-50/80 px-3 py-2">
        <summary className="cursor-pointer text-sm font-medium text-neutral-900">Show commands</summary>
        <div className="mt-3">
