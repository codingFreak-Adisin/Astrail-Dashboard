...
export function EndpointBox({
  ...
  return (
    <div
      className={cn(
        "console-card relative overflow-hidden p-4 transition-all duration-300 sm:p-5",
        copied && "border-emerald-400 shadow-[0_0_0_3px_rgba(16,185,129,0.12)]"
      )}
    >
      {copied && (
      ...
      <div className="flex min-w-0 items-stretch overflow-hidden rounded-xl border border-neutral-200/70 bg-neutral-50">
        <code className="min-w-0 flex-1 overflow-x-auto px-3 py-3 font-mono text-sm leading-8">{endpoint}</code>
        <Button
          type="button"
