...
const sdkCode = `ASTRAIL_SDK_BUNDLE_URL=https://your-domain.com/api/servers/SERVER_ID/sdk \\
...
const generatedFiles = [
  ...
  [".github/workflows/astrail-update.yml", "CI workflow that pulls, verifies, tests, and opens SDK update PRs."],
];
        ...
        <article className="min-w-0 border-white/10 px-4 py-8 sm:px-6 sm:py-10 lg:border-l lg:px-8 xl:border-r">
          <div className="mx-auto max-w-4xl">
            ...
            <section id="auth" className="mt-12 scroll-mt-24">
              <SectionHeading eyebrow="Auth" title="Protect private endpoints with Astrail API keys." />
              <div className="mt-5 border border-white/10 bg-[#151515] p-5">
                <p className="text-base leading-7 text-white/62">
                  Public servers can be called without a bearer token. Private servers require <code className="text-blue-300">Authorization: Bearer ASTRAIL_API_KEY</code>. Upstream provider credentials are attached separately through the credentials API or dashboard.
                </p>
              </div>
            </section>
